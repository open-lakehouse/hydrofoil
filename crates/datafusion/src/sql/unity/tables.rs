...
use sqlparser::ast::{ColumnDef, DataType as SqlDataType, ObjectName};
...
/// this SQL path.
const ENGINE_INFO: &str = concat!("deltalake-datafusion/", env!("CARGO_PKG_VERSION"));
...
mod tests {
    ...
    fn rejects_unsupported_type() {
        let cols = vec![col(
            "amount",
            SqlDataType::Decimal(sqlparser::ast::ExactNumberInfo::None),
        )];
