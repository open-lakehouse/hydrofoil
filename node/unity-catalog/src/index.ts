...
// shared primitives (@open-lakehouse/ui-kit), the UC OpenAPI types
// (@open-lakehouse/uc-client), and exactly one host edge — the environment scope
// id, fed via EnvironmentScopeProvider (./env-seam). See ./README.md.
//
