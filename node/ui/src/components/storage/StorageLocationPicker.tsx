  ...
  return (
    <div className="space-y-2 rounded-md border bg-muted/30 p-3">
      <div className="space-y-1.5">
        <Label htmlFor="storage-location-select">Storage location</Label>
        <Select value={mode} onValueChange={selectMode}>
          <SelectTrigger id="storage-location-select">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
      ...
      {isLocation && (
        <div className="space-y-1.5">
          <Label htmlFor="storage-location-subpath">Subpath (optional)</Label>
          <Input
            id="storage-location-subpath"
            value={subpath}
      ...
      {mode === CUSTOM && (
        <div className="space-y-1.5">
          <Label htmlFor="storage-location-url">Storage URL</Label>
          <Input
            id="storage-location-url"
            value={customUrl}
